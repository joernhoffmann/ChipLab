...
from chiplab_helpers import BINARY_COUNTER, clock_input, sample, start_and_reset
...
async def test_binary_counter(dut):
    ...
    # Count through two complete cycles, including wraparound.
    ...
    assert await sample(dut, BINARY_COUNTER, 0) == held
